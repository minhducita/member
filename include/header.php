...
';
            ...
            else
            {
                ...
                {
                    echo '<script src="/js/mobile-script.js" type="text/javascript"></script>';
                } else {
...
//					fncMenuHead($this->fncMenuHead_imghtml,$this->fncMenuHead_h1text,$this->fncMenuHead_link);
        ...
        public function breadcrumbs($parent='',$parents_children='')
        {
            ...
            if($this->frontpage)
            {
                $breadcrumbs_path ='<div id="topic-path">ワーキング・ホリデー（ワーホリ）協会</div>';
            }
            else
            {
                $breadcrumbs_path ='<p id="topicpath"><a href="/">ワーキング・ホリデー（ワーホリ）協会</a>';
				$texthome = '<a href="/" target="_self">ワーキング・ホリデー（ワーホリ）協会</a>';
